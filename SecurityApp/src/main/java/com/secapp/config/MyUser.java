...
/**
 * Wrapper class to hold Users entity instance in login session
 */
public class MyUser extends User {
	...
	public MyUser(Users user, Collection<? extends GrantedAuthority> authorities) {
		super(user.getUserName(), user.getPassword(), authorities);
		this.user = user;
	}
	
	public MyUser(Users user, boolean enabled, boolean accountNonExpired,
